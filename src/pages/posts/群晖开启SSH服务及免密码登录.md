...
![image-20230527092800109](https://cdn.jsdelivr.net/gh/conscloud/picgotemp/imgplus/202305270928199.png)

### 2.允许ROOT账号登录

通过普通管理员账户进行ssh登录，输入sudo - i 回车后再次输入管理员密码，就能切换到root账户。

![image-20230527093234465](https://cdn.jsdelivr.net/gh/conscloud/picgotemp/imgplus/202305270932547.png)
